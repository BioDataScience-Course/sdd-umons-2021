...
Afin d'accéder à cet espace de discussion, cliquez sur `Assignation GitHub Classroom dédiée aux issues pour les étudiants inscrits au cours de Science des Données Biologiques I à l’UMONS`. Si cette instruction n’apparaît pas, c'est que vous n'êtes pas reconnu comme un étudiant de ce cours.
