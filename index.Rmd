...
- [Plan du cours de Science des données biologiques I : années 2021-2022](https://github.com/BioDataScience-Course/BioDataScience-Common/blob/main/docs/plan_de_cours/2021_sdd1_plan_cours.md) 
...
Toutes les questions relatives aux exercices sont à poser dans les issues GitHub. 

```{r, echo=FALSE, results='asis'}
if (exists("assignation2"))
  assignation("sdd_issues", part = NULL,
