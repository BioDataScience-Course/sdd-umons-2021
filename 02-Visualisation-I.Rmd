...
Avant de vous lancer dans le module suivant, assurez d'avoir appris les notions essentiels de GitHub, de Git, Renku, Rstudio, Commit, Push. 

Le premier module de ce cours vous a permit de découvrir de nouveaux outils comme GitHub, Git, ou encore RStudio. Ces outils vont être employé tout au long de votre formation en science des données (et donc de ce cours). Il est indipensable de les maîtriser.

##### À vous de jouer ! {-}

`r h5p(139, height = 270, toc = "Les outils de la science des données")`


##### À vous de jouer ! {-}

*Avant de poursuivre, vous allez maintenant découvrir les premiers rudiments de R afin de pouvoir réaliser par la suite vos premiers graphiques. Pour cela, vous aurez à lire attentivement et effectuer tous les exercices de deux tutoriels^[Reportez-vous à l'Appendice \@ref(learnr) pour apprendre à utiliser ces tutoriels.].*
...
`r h5p(10, height = 270, toc = "Vidéo d'introduction au graphique en nuage de points")`
...
Inspirez-vous du script dans le dépôt **[sdd1_iris](https://github.com/BioDataScience-Course/sdd1_iris)**. Vous devez commencer par faire un "fork" du dépôt, puis un clone sur votre ordinateur en local pour pouvoir l'utiliser. 
...
`r h5p(8, height = 270, toc = "Vidéo de présentation de R Markdown")`
