...
```{r assign_A06Ga_belgium_demo, echo=FALSE, results='asis'}
if (exists("assignment2"))
  assignment2("A06Ga_belgium_demo", part = NULL,
    url = "https://github.com/BioDataScience-Course/A06Ga_belgium_demo",
    course.ids = c(
      'S-BIOG-006' = !"A06Ga_{YY}M_belgium_demo", 
      'S-BIOG-921' = !"A06Ga_{YY}C_belgium_demo"),
    course.urls = c(
      'S-BIOG-006' = "https://classroom.github.com/a/tohMzuaK", 
      'S-BIOG-921' = "https://classroom.github.com/a/..."),
    course.starts = c(
      'S-BIOG-006' = !"{W[13]+2} 13:00:00"),
    course.ends = c(
...
- Le chapitre relatif aux [données cas par variables (tidy data) de **R for Data Science**](https://r4ds.had.co.nz/tidy-data.html) contient divers exemples et exercices supplémentaires de transformation des données à partir de un ou plusieurs tableaux.
