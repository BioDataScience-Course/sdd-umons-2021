...
Vous êtes à présent des experts dans l'utilisation des issues. Il est temps de rejoindre le dépôt didié aux issues présenté dans le préambule de ce cours \@ref(issues).
...
<!--# G.E. TODO il faut ajouter une petite situation concrète -->
