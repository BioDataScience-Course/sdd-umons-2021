...
if (exists("assignation"))
  assignation("A04Ia_graphe_avance", part = NULL,
    url = "https://github.com/BioDataScience-Course/A04Ia_graphe_avance",
    course.urls = c(
      'S-BIOG-006' = "https://classroom.github.com/a/ncOdTu9s",
...
if (exists("challenge"))
  challenge("A04Ca_charts", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-006' = "https://classroom.github.com/a/8jo-RgSe"),
    toc = "Challenge pour reproduire un maximum de graphiques")
```

::: {.nocourse}
Vous n'êtes pas correctement enregistré pour ce cours. Vous ne pouvez pas participer à ce challenge. Si vous êtes étudiant•e de l'UMONS, vérifiez que vous vous êtes bien enregistré via Moodle...
:::
...
`r launch_shiny("https://sdd.umons.ac.be/A04Ca_charts/", height = 800, delay = 20, toc = NULL, alt1 = "*Cliquez pour visualiser le classement.*", alt2 = "*Cliquez pour visualiser le classement.*")`

<!-- <iframe width="780" height="800" frameborder="0" scrolling="auto" class="shiny-app" id=\"A04Ca_charts\" src="https://sdd.umons.ac.be/A04CA_charts"></iframe> -->
:::
