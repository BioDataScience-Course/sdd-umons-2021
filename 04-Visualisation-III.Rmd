...
if (exists("assignment"))
  assignment("A04Ia_graphe_avance", part = NULL,
    ...
    course.ids = c(
      'S-BIOG-006' = !"A04Ia_{YY}M_graphe_avance", 
      'S-BIOG-921' = !"A04Ia_{YY}C_graphe_avance"),
    course.urls = c(
      'S-BIOG-006' = "https://classroom.github.com/a/ncOdTu9s", 
      'S-BIOG-921' = "https://classroom.github.com/a/..."),
    course.starts = c(
      'S-BIOG-006' = !"{W[9]+1} 10:00:00"),
    course.ends = c(
...
Afin de vous exercer à réaliser des graphiques `chart()`/`ggplot()`, proposez trois graphiques inédits (qui n'ont pas été vu jusqu'ici) dans vos différents projets GitHub Classroom. Employez par exemple les liens suivants pour vous inspirer\ :
...
if (exists("challenge"))
  challenge("A04Ca_charts", part = NULL,
    ...
    course.ids = c(
      'S-BIOG-015' = !"A04Ca_{YY}M_charts"),
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/8jo-RgSe"),
    course.starts = c(
      'S-BIOG-015' = !"{W[9]+5} 08:00:00"),
    course.ends = c(
      'S-BIOG-015' = !"{W[9]+5} 11:00:00"),
