...
```{r assign_A08Ia_pea, echo=FALSE, results='asis'}
if (exists("assignment"))
  assignment("A08Ia_pea", part = NULL,
    url = "https://github.com/BioDataScience-Course/A08Ia_pea",
    course.ids = c(
      'S-BIOG-006' = !"A08Ia_{YY}M_pea", 
      'S-BIOG-921' = !"A08Ia_{YY}C_pea"),
    course.urls = c(
      'S-BIOG-006' = "https://classroom.github.com/a/...", 
      'S-BIOG-921' = "https://classroom.github.com/a/..."),
    course.starts = c(
      'S-BIOG-006' = !"{W[23]+2} 13:00:00"),
    course.ends = c(
      'S-BIOG-006' = !"{W[25]+2} 23:59:59"),
    term = "Q2", level = 3,
...
```{r assign_A08Ga_human_health_I, echo=FALSE, results='asis'}
if (exists("assignment2"))
  assignment2("A08Ga_human_health", part = "I",
    ...
    course.starts = c(
      'S-BIOG-006' = !"{W[25]+2} 10:00:00"),
    course.ends = c(
      'S-BIOG-006' = !"{W[27]+2} 23:59:59"),
    term = "Q2", level = 4, n = 2,
    toc = "Biométrie humaine, part I")
```

**Note\ : Le projet suivant est la continuité d'un exercice débuté au premier quadrimestre.**

```{r assign_A03Ga_urchin, echo=FALSE, results='asis'}
if (exists("assignment2"))
  assignment2("A03Ga_urchin", part = "II",
    ...
    course.ends = c(
      'S-BIOG-006' = !"{W[27]+2} 23:59:59"),
    term = "Q2", level = 4, n = 2,
    toc = "Biométrie de l'oursin violet, part II")
```
