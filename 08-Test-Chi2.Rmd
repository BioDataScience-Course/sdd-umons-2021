...
if (exists("assignment"))
  assignment("A08Ia_pea", part = NULL,
    ...
    course.ids = c(
      'S-BIOG-027' = !"A08Ia_{YY}M_pea", 
      'S-BIOG-921' = !"A08Ia_{YY}C_pea"),
    course.urls = c(
      'S-BIOG-027' = "https://classroom.github.com/a/0WgSkM39", 
      'S-BIOG-921' = "https://classroom.github.com/a/..."),
    course.starts = c(
      'S-BIOG-027' = !"{W[25]+2} 10:00:00"),
    course.ends = c(
      'S-BIOG-027' = !"{W[26]+5} 23:59:59"),
    term = "Q2", level = 3,
...
crabs %>.%
  ...
  janitor::tabyl(., species, sex) %>.% # Tableau de contingence à 2 entrées
  knitr::kable(., caption = "Nombre de crabes mesurés par variété et par sexe.",
    align = "c", escape = FALSE)
```
...
```{r assign_A08Ga_urchin, echo=FALSE, results='asis'}
if (exists("assignment2"))
  assignment2("A08Ga_urchin", part = "II",
    url = "https://github.com/BioDataScience-Course/A03Ga_urchin",
    course.ids = c(
      'S-BIOG-027' = !"A03Ga_{YY}M_urchin",
